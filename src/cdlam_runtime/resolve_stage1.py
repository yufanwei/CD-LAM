...
def _translate_public_recipe(config: dict) -> None:
    """Translate stable CD-LAM names into pinned compatibility flags."""
    ...
    reconstruction_names = {
        "enabled": "v5_mode",
        "partial_full_mix": "v5_partial_fullmix",
        "foreground_weight": "v5_lambda_fg",
        "background_weight": "v5_gamma_bg",
        "full_frame_weight": "v5_rho_full",
        "min_foreground_pixels": "v5_min_pixels_fg",
        "min_background_pixels": "v5_min_pixels_bg",
    }
    ...
    extension_names = {
        "structured_graph": "siglip_use_v42_graph",
        "split_loss": "siglip_action_loss_split",
        "grouped_action_loss": "siglip_action_loss_v46_enabled",
    ...
    cadence["f1_v3_baseline_ckpt"] = cadence.pop("baseline_checkpoint")
...
def resolve_config(
    ...
    *,
    ...
    _translate_public_recipe(config)
