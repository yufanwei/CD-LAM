...
condition. The trainer is exposed through the semantic CD-LAM integration
package staged alongside the pinned world-model source.
...
def _patch_decode_window_to_shard():
    ...
    """
    import cdlam_integration.world_model.train as T
...
def _patch_lam_checkpoint_validation():
    ...
    import cdlam_integration.world_model.model_loader as L
...
def _patch_registry_config():
    ...
    import cdlam_integration.world_model.registry as R
