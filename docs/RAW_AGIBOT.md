...
The core data environment needs `numpy`, `h5py`, `pandas`, a
Parquet engine such as `pyarrow`, and PyAV. PyAV is used to check the video
stream, frame count, and 30 FPS contract without decoding the full video.
