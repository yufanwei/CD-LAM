...
The supported bootstrap fetches the pinned ACWM source and stages the verified
CD-LAM runtime automatically. To refresh or verify only that external source:
