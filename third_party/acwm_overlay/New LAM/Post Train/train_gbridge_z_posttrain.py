...
from train_lerobot_robot_action_posttrain import (  # noqa: E402
    SLICE_BY_EMBODIMENT,
    _avg_scalar,
    _json_default,
...
def main() -> None:
    ...
    ap.add_argument(
        "--init-trainable-from",
        required=True,
        help="V7 pretrained WM, e.g. outputs/wm_v7/WM_V7_300masked_corrected_20260516_184138/ckpt_step4000.pt",
    )
    ap.add_argument(
    ...
    ap.add_argument(
        "--gr-bridge-ckpt",
        default=str(
            ROOT / "New LAM/bridge_head/agibot_beta_22d/a22z_agibot_beta_D_cyc3.pt"
        ),
    ...
    from lamwm_pipline.tools.train_wm_compat_real import patch_forward_to_use_cached_z
