"""LAM masked data extensions — fg + bg mask loading.

pairwise only loaded interact (fg) mask for L_rec_inter. masked needs both fg AND bg
...
class FgBgMaskCache:
    ...
    Same API as :class:`cdlam_integration.lam.data.MaskCache` but returns a
