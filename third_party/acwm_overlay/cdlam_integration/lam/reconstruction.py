"""LAM masked loss extensions — fg-weighted reconstruction + bg consistency.

pairwise had 4 reconstruction-related losses (L_rec_full, α·L_rec_inter, L_use_full,
η·L_use_inter) — all in service of "make decoder use z and reconstruct
interaction region". masked reduces this to 2 losses using preprocessed RoboSAM
fg/bg masks:
