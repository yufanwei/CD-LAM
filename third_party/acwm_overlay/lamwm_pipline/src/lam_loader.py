...
Two ckpt formats handled:
    ...
    finetune_ddp  — output of finetune_4-30/scripts/train_ddp.py.
...
Usage:
    ...
    enc, lam_module = build_encoder("lam_v1_camera_clean_step9800", device="cuda")
...
from model import LAMEncoderForFinetune, build_lam, freeze_all  # noqa: E402
...
def build_encoder(
    ...
    if fmt == "latent_action_state_dict":
        ...
        # LAM_V5.tools.train_lam_v5.load_init_ckpt onto build_lam("CD_LAM_BASE").lam
